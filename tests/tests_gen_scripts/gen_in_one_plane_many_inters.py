...
TEST_DATA_DIR   = common.SCRIPT_DIR + "/tests_data/in_one_plane_many_inters/"
NUM_TESTS       = 10
...
def generate_triangles():
  ...
  for _ in range(NUM_TRIANGLES):
    t_left  = common.random_double(0, 1)
    t_top   = common.random_double(0, 1)
    t_right = common.random_double(0, 1)

    point_a = common.Point(-HALF_BOX_SIDE_LEN, -HALF_BOX_SIDE_LEN + t_left * BOX_SIDE_LEN, 0)
    point_b = common.Point(-HALF_BOX_SIDE_LEN + t_top * BOX_SIDE_LEN, HALF_BOX_SIDE_LEN,   0)
    point_c = common.Point( HALF_BOX_SIDE_LEN, HALF_BOX_SIDE_LEN - t_right * BOX_SIDE_LEN, 0)
